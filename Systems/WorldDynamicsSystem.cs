...
namespace RPGMods.Systems
{
    public static class WorldDynamicsSystem
    {
        ...
        public static void MobReceiver(Entity entity)
        {
            ...
            /*if (DamageVsPlayerVampires != 0) unitStats.DamageVsPlayerVampires.SetBaseValue(DamageVsPlayerVampires, floatBuffer);
            if (ResistVsPlayerVampires != 0) unitStats.ResistVsPlayerVampires.SetBaseValue(ResistVsPlayerVampires, floatBuffer);*/
